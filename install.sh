...
echo -e "${BLUE}                                                     \\$$$$$$  \\$$$$$$$${NC}"
echo -e "${YELLOW}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
echo -e "  ${GREEN}AutoScript VPN Server v4.0 - ALRELSHOP Edition${NC}"
echo -e "  ${YELLOW}» Quick Setup Multi-Protocol VPN Server ${NC}"
...
if [[ $OS_ID == "ubuntu" ]]; then
    case $OS_VERSION in
        "18.04"|"20.04"|"22.04"|"24.04"|"25.04")
            ...
            ;;
        *)
            echo -e "${ERROR} Ubuntu version $OS_VERSION is not supported. Supported: 18.04, 20.04, 22.04, 24.04, 25.04"
            exit 1
            ;;
    esac
    ...
    case $OS_VERSION in
        "9"|"10"|"11"|"12")
            ...
            ;;
        *)
            echo -e "${ERROR} Debian version $OS_VERSION is not supported. Supported: 9, 10, 11, 12"
            exit 1
            ;;
    esac
else
    echo -e "${ERROR} Your OS Is Not Supported ( ${YELLOW}$OS_NAME${NC} )"
    echo -e "${ERROR} Supported OS: Ubuntu 18.04-25.04, Debian 9-12"
    exit 1
fi
...
echo ""
echo -e "${GREEN}Starting automatic installation in 3 seconds...${NC}"
echo ""
sleep 3
clear
if [ "${EUID}" -ne 0 ]; then
...
echo ${host1:-alrelshop.my.id} > /root/domain
echo ""
elif [[ $host == "2" ]]; then
#install cf
...
function password_default(){
    ...
    echo -e "Password default untuk user telah di-setup"
...
echo -e "\e[32mloading...\e[0m" 
clear
izinsc="https://raw.githubusercontent.com/alrel1408/NewAutoScript/main/Register"
# USERNAME
rm -f /usr/bin/user
...
print_install "Memasang SSL Pada Domain"
    ...
    domain=$(cat /root/domain 2>/dev/null || echo "alrelshop.my.id")
...
wget -q https://raw.githubusercontent.com/alrel1408/NewAutoScript/main/config/fv-tunnel && chmod +x fv-tunnel && ./fv-tunnel
...
echo ""
echo -e "${YELLOW}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
echo -e "  ${GREEN}✓ ALRELSHOP AutoScript v4.0 Successfully Installed!${NC}"
echo -e "  ${BLUE}✓ Multi OS Support: Ubuntu 18-25, Debian 9-12${NC}"
echo -e "  ${YELLOW}✓ Auto Menu Entry Enabled${NC}"
echo -e "  ${GREEN}Developer: ALRELSHOP® | Repository: alrel1408/NewAutoScript${NC}"
echo -e "${YELLOW}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
echo ""
